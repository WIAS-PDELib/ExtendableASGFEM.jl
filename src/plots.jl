...
"""
function plot_modes(sol::SGFEVector; unknwon = 1, Plotter = nothing, nmodes = num_multiindices(sol.TB), ncols = 3, width = 400*ncols, sort = false)
